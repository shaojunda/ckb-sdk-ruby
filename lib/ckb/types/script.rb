...
module CKB
  module Types
    class Script
      ...
      def self.generate_lock(target_pubkey_blake160, secp_cell_type_hash)
        new(
...
# api = CKB::API.new(host: "http://18.162.80.155:8118")
# block = api.get_block_by_number(1000)
# tx = block.transactions.first
# script = tx.outputs.first.lock  api.system_script_code_hash